...
/datum/species/dwarf/mountain
	...
	specstats = list(STATKEY_STR = 0, STATKEY_PER = 0, STATKEY_INT = 0, STATKEY_CON = 3, STATKEY_END = 3, STATKEY_SPD = -2, STATKEY_LCK = 0)
	specstats_f = list(STATKEY_STR = 0, STATKEY_PER = 0, STATKEY_INT = 0, STATKEY_CON = 3, STATKEY_END = 3, STATKEY_SPD = -2, STATKEY_LCK = 0)
